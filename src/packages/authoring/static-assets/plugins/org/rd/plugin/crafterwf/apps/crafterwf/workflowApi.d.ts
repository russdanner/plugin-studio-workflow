...
export declare const TRANSITION_BLOCKED_MESSAGE = "Packages cannot be moved directly to that step";
export declare function isTransitionMoveAllowed(sourceList: Pick<BoardView['lists'][number], 'transitionStepIds'>, targetStepId: string): {
    allowed: boolean;
    message?: string;
};
export declare function isListDropAllowedForDraggedPackage(sourceList: BoardView['lists'][number] | undefined, targetList: BoardView['lists'][number], packageSummary: {
    contentPaths?: string[];
    contentTypes?: string[];
}, userGroups: string[]): {
    allowed: boolean;
