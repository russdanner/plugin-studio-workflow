...
export declare type CalendarEventSourceId = 'task' | 'package';
...
export declare const CALENDAR_UPDATED_EVENT = "crafterwf:calendar-updated";
export declare function notifyCalendarUpdated(): void;
