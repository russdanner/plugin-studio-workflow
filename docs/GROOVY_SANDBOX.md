...
```yaml
studio.scripting.allowedBeans: dataSource,securityService,userService,contentService,cstudioContentService,studio.workflowService,publishService,cstudioServicesConfig
```
